...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function initColorPicker() {
    ...
    function updatePriceMatrix() {
      ...
      if (window.innerWidth <= 991) {
        ...
        containerToInsert = document.querySelector('.left_block .product-main .js_price_wrapper .price_matrix_wrapper');
      }
      ...
      displayElement.innerHTML = `
          <div style="display: flex; align-items: center; gap: 4px;">
            Доп. окрашивание: <span class="js-selected-color">${selectedOption.color}</span>
            <div class="explanation-element">
              <div class="icon">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <rect x=".5" y=".5" width="15" height="15" rx="7.5" stroke="#E5E5E5"></rect>
                  <path d="M8.729 6.445q0 .924-.066 1.683-.067.748-.165 1.496H7.86a35 35 0 0 1-.165-1.496 20 20 0 0 1-.066-1.683V4.377h1.1zm.187 4.961q0 .297-.198.517t-.54.22-.538-.22a.75.75 0 0 1-.198-.517q0-.297.198-.517.197-.22.539-.22.34 0 .539.22a.75.75 0 0 1 .198.517" fill="#555"></path>
                </svg>
              </div>
              <div class="content">
    ...
    colorPickerItems.forEach((item) => {
      item.addEventListener('click', (e) => {
        ...
        selectedOption.color = item.textContent;
  ...
  function addInstalmentsInfo() {
    ...
    var parent = document.querySelector('.js-prices-in-side .wrapp-one-click');
