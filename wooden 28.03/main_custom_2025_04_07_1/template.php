...
<div class="product-info-wrapper">
                            ...
                            <div class="prices_block">
                                ...
                                <?$this->SetViewTarget('PRODUCT_SIDE_INFO', 300);?>
                                    ...
                                    <div class="explanation-element">
                                        <div class="icon">
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x=".5" y=".5" width="15" height="15" rx="7.5" stroke="#E5E5E5"/><path d="M8.729 6.445q0 .924-.066 1.683-.067.748-.165 1.496H7.86a35 35 0 0 1-.165-1.496 20 20 0 0 1-.066-1.683V4.377h1.1zm.187 4.961q0 .297-.198.517t-.54.22-.538-.22a.75.75 0 0 1-.198-.517q0-.297.198-.517.197-.22.539-.22.34 0 .539.22a.75.75 0 0 1 .198.517" fill="#555"/></svg>
                                        </div>
    ...
    <div class="info-column">
        ...
        <div class="color-row">
            ...
            <div class="color-picker-container" style="display: none;">
                ...
                <div class="color-picker-grid">
                    <?php
                    $activeId = 2;
                    // Для примера выводим один и тот же цвет и название несколько раз
                    for ($i = 0; $i < 9; $i++):
                    $isActive = isset($activeId) && $i == $activeId - 1;
                    ?>
                    <div class="color-picker-item<?= $isActive ? ' active' : '' ?>" style="background-image: url(https://test.wooden-world.ru/upload/uf/bbd/s46zxhdkt8a3fhqu88atieig1r3xnfja.jpg)">
                        Без окрашивания
                    </div>
                    <?php endfor; ?>
                </div>
                ...
                <div class="color-picker-buttons">
                    <button class="btn btn-default submit" type="button">Подтвердить</button>
        ...
        <div clas="characteristics-wrapper">
