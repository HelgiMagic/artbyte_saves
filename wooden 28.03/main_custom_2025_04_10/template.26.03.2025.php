											...
											<div class="votes_block nstar with-text" itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
												...
												<div class="ratings">
													...
													<div class="inner_rating" title="<?=$message?>">
														<div class="item-rating <?= 0 <= $arItem['PROPERTIES']['EXTENDED_REVIEWS_RAITING']['VALUE'] ? 'filed' : ''?>"><?=CMax::showIconSvg("star", SITE_TEMPLATE_PATH."/images/svg/catalog/star_small.svg");?></div>
														<span class="font_sxs"><?= $arResult['PROPERTIES']['EXTENDED_REVIEWS_RAITING']['VALUE'] ?></span>
														
														<?/*for($i=1;$i<=5;$i++):
															echo "<pre>"; print_r($arResult); echo "</pre>";
															?>
															<div class="item-rating <?=$i<=ceil((float)$arResult['PROPERTIES']['EXTENDED_REVIEWS_RAITING']['VALUE']) ? 'filed' : ''?>"><?=CMax::showIconSvg("star", SITE_TEMPLATE_PATH."/images/svg/catalog/star_small.svg");?></div>
														<?endfor;*/?>
													</div>
												</div>
											</div>
												...
												<div class="votes_block nstar with-text">
													<div class="ratings">
														<div class="inner_rating">
															<div class="item-rating"><?=CMax::showIconSvg("star", SITE_TEMPLATE_PATH."/images/svg/catalog/reviews.svg");?></div>
				...
				<?ob_start()?>
					...
					<?if( ($arResult['DISPLAY_PROPERTIES'] || $arResult['OFFER_PROP']) && $arParams['VISIBLE_PROP_COUNT'] > 0 ):?>
						<div class="char-side">
							...
							<div class="edost_C2_button" style="cursor: pointer;" onclick="edost_RunScript('window', '<?=$product_id?>', '<?=$product_name?>', 'edost_catalogdelivery_calculate_button'); ym(87688230,'reachGoal','click_cal_delivery_in_cart')">
						...
						<div class="prices_block">
							...
							<?$this->SetViewTarget('PRODUCT_SIDE_INFO', 300);?>
                                ...
                                <?$APPLICATION->IncludeComponent(
                                    ...
                                    "",
                                    Array(
                                        "AREA_FILE_SHOW" => "file", // или "page", или "sect"
                                        "AREA_FILE_SUFFIX" => "inc", // Суффикс имени файла включаемой области
                                        "AREA_FILE_RECURSIVE" => "Y", // Искать файл в родительских директориях
                                        "EDIT_TEMPLATE" => "", // Путь к шаблону редактирования области
                                        "PATH" => "/include/NDS_text.php" // Путь к файлу включаемой области
                                    ),
                                    false
                                );?>
							<?$this->EndViewTarget();?>
								...
								<div class="js-prices-in-side product-action">
									<div class="buy_block js-product-buy-block">
                                        ...
                                        <div class="instalments-buy">
                                            <button class="instalments-btn btn btn-transparent-border-color transition_bg has-ripple">Купить в рассрочку ?</button>
                                            <div class="instalments-buy-content d-none">
