...
//выпиливаем ползунок с ценами конец!!!
								...
								<?php
									...
									$arItem['CHECKED_COUNT'] = $countActive ?: 0;
									// --- НАЧАЛО ИЗМЕНЕНИЙ ---
      ...
      <button
        ...
        style="color: <?= $arItem['CHECKED_COUNT'] ? '#0055C7' : '#888D96' ?>"
      >
        <svg width="9" height="10" viewBox="0 0 9 10" fill="none" xmlns="http://www.w3.org/2000/svg">
          <line x1="0.353553" y1="0.646569" x2="8.57794" y2="8.87095" stroke="<?= $arItem['CHECKED_COUNT'] ? '#0055C7' : '#888D96' ?>"/>
          <line x1="0.421837" y1="8.87081" x2="8.64622" y2="0.646428" stroke="<?= $arItem['CHECKED_COUNT'] ? '#0055C7' : '#888D96' ?>"/>
        </svg>
