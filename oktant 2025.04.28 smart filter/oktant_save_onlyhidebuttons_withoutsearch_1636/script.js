...
document.addEventListener('DOMContentLoaded', () => {
  $(document).on('click', '.toggle-list-button', function () {
    ...
    function updateList(expanded) {
      ...
      window.toggleStates = window.toggleStates || {};
      window.toggleStates[idx] = expanded;
      console.log(idx, expanded);
      document.cookie = 'toggleStates=' + encodeURIComponent(JSON.stringify(window.toggleStates)) + '; path=/';
      console.log(window.toggleStates);
    }
