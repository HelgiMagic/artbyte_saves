								...
								foreach($arResult["ITEMS"] as $key=>$arItem)
								{
									...
									<div class="products-sidebar-item">
										<div class="products-sidebar-item-title <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>active<?endif;?>">
											<div class="products-sidebar-item-title-text"><?=$arItem["NAME"]?></div>
											<?
															...
															<?foreach($arItem["VALUES"] as $val => $ar):?>																
																<li>
																	<label data-role="label_<?=$ar["CONTROL_ID"]?>" class="checkbox-label products-filter-checkbox-label <?// echo $ar["DISABLED"] ? 'disabled': '' ?>">
																		<input type="checkbox" class="checkbox startfiltersearch" value="<? echo $ar["HTML_VALUE"] ?>" name="<? echo $ar["CONTROL_NAME"] ?>" id="<?=$ar["CONTROL_ID"];?>" <? echo $ar["CHECKED"]? 'checked="checked"': '' ?>/>
																		<span class="products-filter-checkbox-title"><?=$ar["VALUE"];?></span>
																		<?if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])):?>
																		(<span data-role="count_<?=$ar["CONTROL_ID"]?>" class="products-filter-checkbox-count"><? echo $ar["ELEMENT_COUNT"]; ?></span>)
																		<?endif;?>																		
																	</label>
																</li>
															<?endforeach;?>
