...
(function () {
  ...
  BX.Sale.OrderAjaxComponent = {
    ...
    init: function (parameters) {
      ...
      this.isUserAuth = parameters.isUserAuth === 1;
    ...
    editRegistrationForm: function (authContent) {
      ...
      if (showSmsConfirm) {
        ...
        if (this.result.AUTH.new_user_phone_auth === "Y") {
          ...
          this.bindInputmaskPhone(phoneContainerNode);
              ...
              BX.create("INPUT", {
                ...
                events: {
                  click: BX.delegate(function (e) {
                    ...
                    if (arLiteOptions.THEME.LOGIN_EQUAL_EMAIL === "Y") {
                      if (login && email) {
      ...
      var couponsList = this.getCouponsList(true),
        ...
        couponsBlock = BX.create("DIV", {
          ...
          children: [
            ...
            BX.create("SPAN", { props: { className: "bx-soa-coupon-item mt mt--6" }, children: couponsList }),
          ],
        });

      basketItemsNode.appendChild(
        BX.create("DIV", {
          props: { className: "bx-soa-coupon m-block m-block--24" },
    ...
    getCouponNode: function (coupon, active) {
      ...
      return BX.create("STRONG", {
        attrs: {
          ...
          className: `bx-soa-coupon-item-${couponItem} pt pt--8 font_15 font_normal`,
        },
        children: active
          ? [
              //couponName || "",
    ...
    getZipLocationInput: function (node) {
      ...
      if (zipProperty) {
        ...
        const $zipWrapper = BX.create("DIV", { props: { className: "grid-list__item" }, children: [$zipInner] });
      ...
      if (personTypesCount > 2) {
        ...
        for (i in this.result.PERSON_TYPE) {
          if (this.result.PERSON_TYPE.hasOwnProperty(i)) {
            currentType = this.result.PERSON_TYPE[i];
            label = BX.create("LABEL", {
              props: { className: 'chip__label mb' },
              children: [
                BX.create("INPUT", {
            ...
            node.appendChild(
              BX.create("DIV", {
                props: { className: "person-type chip bg-theme-active color-theme-hover-no-active" + (currentType.CHECKED == "Y" ? " active" : "") },
                children: [label],
              })
            );
    ...
    editPaySystemItems: function (paySystemNode) {
      ...
      var paySystemItemsContainer = BX.create("DIV", { props: { className: "bx-soa-pp-item-container grid-list grid-list--gap-20" } }),
        paySystemItemNode,
        i;
    ...
    createPaySystemItem: function (item) {
          ...
          html:
            ...
            (this.uniqueText(item.DESCRIPTION)
              ? "<div class='hint colored_theme_hover_bg-block'>" +
                "<span class='hint__icon hint__icon--filled rounded colored_theme_hover_bg-el'><i>?</i></span>" +
                "<div class='tooltip'>" +
                item.DESCRIPTION +
                "</div>" +
                "</div>"
      ...
      */
      ...
      itemNode = BX.create("DIV", {
        ...
        props: { className: "bx-soa-pp-company bx-soa-pp-company-item grid-list__item" },
    ...
    getInnerPaySystem: function () {
      ...
      label = BX.create("LABEL", {
        props: {
          className: "bx-soa-pp-company-subTitle form-checkbox__label form-checkbox__label--sm" + (isSelected ? " checked" : ""),
      ...
      htmlString = BX.message('INNER_PS_BALANCE_DEFAULT') + ' <b class="wsnw">' + this.result.CURRENT_BUDGET_FORMATED
      	+ '</b>';
    ...
    editActiveDeliveryBlock: function (activeNodeMode) {
      ...
      if (this.initialized.delivery) {
        ...
        deliveryNode = BX.create("DIV", { props: { className: "bx-soa-pp grid-list grid-list--items-1 grid-list--gap-20" } });
    ...
    getDeliveryCompactInfo: function () {
      ...
      if (currentDelivery) {
        ...
        const $deliveryLabel = BX.create("div", {
          props: { className: "bx-compact-title pb pb--10" },
        ...
        if ($zipProp) {
          const $zip = BX.create("div", {
            props: { className: "bx-compact-prop font_16" },
    ...
    showPropInDelivery: function (propCode, node, title) {
      ...
      if (title) {
        titleNode = BX.create("DIV", {
          props: {
            className: "bx-soa-title-subblock color_222",
          },
          text: title,
        });
      }
      ...
      const $prop = BX.create("DIV", {
        props: {
          className: "grid-list__item bx-soa-extraprops group-without-margin",
        },
        children: [$propInner],
      });
      let isAddProp = false;
    ...
    showPickUp: function (node) {
      const $pickup = BX.create("div", {
        ...
        children: [
          BX.create("div", {
            props: {
              className: "bx-soa-section-content bx-soa-section-content--no-gutters bx-soa-pp-company-item",
            },
          }),
        ],
      });
    ...
    editDeliveryItems: function (deliveryNode) {
      ...
      var deliveryItemsContainer = BX.create("DIV", { props: { className: "bx-soa-pp-item-container grid-list__item grid-list grid-list--gap-20" } }),
        deliveryItemNode,
        k;
    ...
    editDeliveryInfo: function (deliveryNode) {
      ...
      if (extraServices.length) {
        extraServicesNode = BX.create("DIV", {
          props: { className: "bx-soa-pp-company-item grid-list__item" },
          children: extraServices,
        });
        deliveryNode.appendChild(
          BX.create("DIV", { props: { className: "bx-soa-extraservices grid-list__item grid-list" }, children: [extraServicesNode] })
        );
        extraServicesNode = BX.create("DIV", {
          props: { className: "bx-soa-pp-company-block" },
          children: extraServices,
      ...
      for (i in delivery.EXTRA_SERVICES) {
        ...
        if (currentService.editControl.indexOf("this.checked") == -1) {
          ...
          serviceNode = BX.create("DIV", {
            ...
            children: [
              currentService.editControl.replace("onchange", 'id="' + serviceID[1] + '" class="form-checkbox__input" onchange'),
              BX.create("LABEL", {
                props: {
                  htmlFor: serviceID[1],
      ...
      storeNode = BX.create("DIV", {
        ...
        children: [
          ...
          BX.create("DIV", {
            ...
            children: [
              BX.create("A", {
                props: { href: "javascript:;", className: "btn btn-sm btn-transparent-border" },
    ...
    editActivePropsBlock: function (activeNodeMode) {
      ...
      if (this.initialized.props) {
        ...
        propsNode = BX.create("DIV", { props: { className: 'bx-soa-customer-container'}});
        // selectedDelivery = this.getSelectedDelivery();
    ...
    showSaveProfile: function (node) {
      ...
      const html = '<div style="font-size: 12px; margin-top: -24px;">Нажимая на кнопку "Продолжить", вы подтверждаете ознакомление с <a href="/include/Политика_ОПД.pdf">Политикой в отношении обработки персональных данных</a></div>';
    ...
    showInfoFromProps: function (node) {
      ...
      node.appendChild(
        BX.create("div", {
          ...
          children: [
            BX.create("div", { props: { className: "col-sm-12 bx-soa-pp-item-container grid-list grid-list--gap-20" }, children: content }),
            newProfile,
            profileChangeInput,
          ],
        })
    ...
    showPropItem: function (profile) {
      ...
      if (checked === "Y") {
        changeProfile = BX.create("DIV", {
          ...
          html:
            "<span class='bx-soa-change-profile font_14'>" + BX.message("TITLE_SOA_CHANGE_INFO_SECTION") + "</span>",
      ...
      const content = BX.create("div", {
        props: {
          className: "bx-soa-pp-company bx-soa-pp-company-item grid-list__item",
        },
        children: [itemInnerNode],
      });
    ...
    editPropsItems: function (propsNode) {
      ...
      <div style="display: flex; flex-direction: column;">
        <div class="prompt remember pull-left form-checkbox" style="margin-top: 10px;">
          <input type="checkbox" class="form-checkbox__input" id="licenses_subscribe" name="licenses_subscribe" required value="Y">
          <label for="licenses_subscribe" class="form-checkbox__label">
            <span>Даю согласие на обработку <a href="/include/sopd_store_goldenrinrun.pdf">персональных данных</a></span>
            <span class="form-checkbox__box"></span>
          </label>
        </div>
      
        <div class="prompt remember pull-left form-checkbox" style="margin-top: 10px; margin-bottom: 10px;">
          <input type="checkbox" class="form-checkbox__input" id="UF_SUBSCRIBE" name="UF_SUBSCRIBE" value="0">
          <label for="UF_SUBSCRIBE" class="form-checkbox__label">
            <span>Даю согласие на получение <a href="/include/Согласие_на_рассылку.pdf">рекламной и новостной рассылки</a></span>
            <span class="form-checkbox__box"></span>
          </label>
        </div>
      </div>
      ...
      propsItemsContainer.insertAdjacentHTML('beforeend', html);
    },
    ...
    getPropertyRowNode: function (property, propsItemsContainer, disabled, with_column) {
      ...
      if (this.isUserAuth) {
        ...
        if (propertyId == 22) {
          setTimeout(function() {
            $('[data-property-id-row="22"] input').val('Y');
            $('[data-property-id-row="22"] input[type="checkbox"]').prop('checked', true);
          }, 5);
        }
      }
    },
    ...
    insertStringProperty: function (property, propsItemNode, disabled) {
      ...
      if (disabled) {
        ...
        if (property.getSettings().IS_PHONE === "Y") {
          ...
          this.bindInputmaskPhone(propContainer);
        }
        this.bindValidation(property.getId(), propContainer);
      }
    },
    ...
    bindInputmaskPhone: function (propContainer) {
      if(arAsproOptions['THEME']['PHONE_MASK'].length){
        let $input = propContainer.querySelector('.phone');
        if ($input) {
          $($input).inputmask('mask', {'mask': arAsproOptions['THEME']['PHONE_MASK'], 'showMaskOnHover': false });
        }
			}
    },
    ...
    editPropsMap: function (propsNode) {
      var propsMapContainer = BX.create("DIV", { props: { className: "grid-list__item" }, style: { marginBottom: "10px" } }),
    ...
    editPropsComment: function (propsNode) {
      ...
      propsCommentContainer = BX.create("DIV", { props: { className: "grid-list__item" } });
      label = BX.create("LABEL", {
    ...
    editTotalBlock: function () {
      ...
      if (!this.result.SHOW_AUTH) {
        ...
        this.totalInfoBlockNode.appendChild(
          BX.create("DIV", {
            props: {
              className: "bx-soa-cart-total-button-container mt mt--24 lic_condition" + (!showOrderButton ? " visible-xs" : ""),
            },
            children: [
              BX.create("A", {
                props: {
        ...
        const conditions = []; 
        if (arAsproOptions["THEME"]["SHOW_OFFER"] == "Y" || arAsproOptions["THEME"]["SHOW_LICENCE"] == "Y") {
            console.log('this.totalInfoBlockNode', this.totalInfoBlockNode);
            const html = `
            <div class="prompt remember form-checkbox" style="margin-top: 10px;">
                <input type="checkbox" class="form-checkbox__input" id="purchase_agreement" name="purchase_agreement" required value="Y">
                <label for="purchase_agreement" class="form-checkbox__label">
                    <span>С <a href="/include/offer_detail.php">условиями</a> покупки товара ознакомлен и согласен</span>
                    <span class="form-checkbox__box"></span>
                </label>
            </div>
            `;

            this.totalInfoBlockNode.insertAdjacentHTML("beforeend", html);
        //     conditions.push(
        //       BX.create("span", {
        //         html: BX.message(arAsproOptions["THEME"]["SHOW_OFFER"] == "Y" && arAsproOptions["THEME"]["SHOW_LICENCE"] == "Y" ? 'LICENSES_OFFER_TEXT' : (arAsproOptions["THEME"]["SHOW_OFFER"] == "Y" ? "OFFER_TEXT" : "LICENSES_TEXT")),
        //       })
        //     );          
        //   let href = arAsproOptions["SITE_DIR"] + "include/offer_detail.php";
        //   let tmpUrl = BX.message("LICENSES_OFFER_TEXT").match(/href="(.+?)"/);
        //   if (tmpUrl) {
        //     href = tmpUrl[1];
        //   }
        }  
        if (conditions.length > 0) {          
          if (!this.totalBlockNode.querySelector(".bx-soa-cart-conditions")) {
            this.totalBlockNode.querySelector(".bx-soa-total-wrapper").appendChild(
              BX.create("DIV", {
                props: {
                  className: "bx-soa-cart-conditions p-inline p-inline--20 text-center mt mt--24",
                },
                children: [
                  BX.create("div", {
                    props: {
                      className: "bx-soa-cart-conditions-text font_13",
                    },
                    children: conditions,
                  }),
                ],
    ...
    editMobileTotalBlock: function () {
      ...
      // custom code
      this.mobileTotalBlockNode.querySelector('#purchase_agreement').setAttribute('name', 'purchase_agreement_mobile');
      this.mobileTotalBlockNode.querySelector('#purchase_agreement').setAttribute('id', 'purchase_agreement_mobile');
      this.mobileTotalBlockNode.querySelector('[for="purchase_agreement"]').setAttribute('for', 'purchase_agreement_mobile');
    ...
    showTotalDeliveryInfo: function () {
      ...
      if (curDelivery) {
        ...
        if (curDelivery["PERIOD_TEXT"]) {
          ...
          this.totalInfoBlockNode.appendChild(
            BX.create("div", {
              props: { className: "total-delivery-info color_666 font_14 mt mt--4" },
    ...
    createTotalScrollInfo: function (name, info, block) {
      return BX.create("div", {
        props: { className: "total-scroll-info font_15 mt mt--10" },
        children: [
          BX.create("div", { props: { className: "total-scroll-info__title font_weight--500" }, text: name + ":" }),
          BX.create("div", {
            props: {
              className:
    ...
    createTotalUnit: function (name, value, params) {
      ...
      let className = "bx-soa-cart-total-line",
          childTitleClass = 'bx-soa-cart-t',
          childValueClass = 'bx-soa-cart-d';

      name = name || "";
      value = value || "";
      params = params || {};

      if (!!params.total && this.options.totalPriceChanged) {
        childValueClass += 'bx-soa-changeCostSign';
      }
      ...
      if (params.total) {
        className += " bx-soa-cart-total-line-totals mb mb--16";
				childTitleClass += ' font_24 font_weight--500';
				childValueClass += ' font_24 font_weight--500';
      } else {
        childTitleClass += ' font_15';
        childValueClass += ' font_15';
        className += ' mb mb--8';
      }
      ...
      return BX.create("DIV", {
        ...
        children: [
          BX.create("SPAN", { props: { className: childTitleClass }, text: name }),
          BX.create("SPAN", { props: { className: childValueClass }, children: totalValue }),
        ],
      });
    },
    ...
    totalBlockFixFont: function () {
      ...
      if (this.params.SHOW_TOTAL_ORDER_BUTTON == "Y") {
        buttonNode = this.totalInfoBlockNode.querySelector(".bx-soa-cart-total-button-container mt mt--24");
        if (buttonNode) {
