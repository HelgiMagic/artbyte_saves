                    ...
                    <li>
                        <a href="#" class="product-print-link">
                            ...
                            <div class="product-form-body">
                                ...
                                <div class="item-prices prodelement" itemprop="offers" itemscope="itemscope" itemtype="https://schema.org/Offer">
                                    <?if($allcount>0):?>
                                    ...
                                    */ ?>
                                        	...
                                        	<meta itemprop="price" content="<?= !empty($price['PRINT_RATIO_PRICE']) ? $price['PRINT_RATIO_PRICE'] : 'По запросу' ?>">
                                        ...
                                        <? foreach ($proptable1 as $n => $p) { ?>
                                            ...
                                            <tr itemprop="additionalProperty" itemscope="itemscope" itemtype="https://schema.org/PropertyValue">
                                                ...
                                                <td class="proprightvalue">
                                                    ...
                                                    <?else:?>
                                                        <span itemprop="value"><?=$p["NAME"];?>  <?=$p["HINT"]?></span>
                                                    <?endif;?>
                                                </td>
                                            </tr>
                                        <? } ?>
	                        ...
	                        <? } ?>
	                            ...
	                            <div class="">
                                    <table class="product-info-table product-specifications-table">
                                            ...
                                            <tr itemprop="additionalProperty" itemscope="itemscope" itemtype="https://schema.org/PropertyValue">
                                                <td>
                                                    <div class="product-info-table-title"><span itemprop="name">Вес нетто</span></div>
                                                </td>
                                                <td class="proprightvalue">
                                                        <span itemprop="value"><?=round($arResult['PROPERTIES']["VES"]["VALUE"], 3)?>  <?=$arResult['PROPERTIES']["VES"]["HINT"]?></span>
                                                </td>
                                            </tr>
                                            <? } ?>
                                            ...
                                            <tr itemprop="additionalProperty" itemscope="itemscope" itemtype="https://schema.org/PropertyValue">
                                                <td>
                                                    <div class="product-info-table-title"><span itemprop="name">Объём</span></div>
                                                </td>
                                                <td class="proprightvalue">
                                                        <span itemprop="value"><?=round($arResult['PROPERTIES']["OBYOM"]["VALUE"], 6)?>  <?=$arResult['PROPERTIES']["OBYOM"]["HINT"]?></span>
                                                </td>
                                            </tr>
                                            <? } ?>
                                            <? if(!empty($arResult['PROPERTIES']["KRATNOST_PRODAZHI"]["VALUE"])) { ?>
                                            <tr itemprop="additionalProperty" itemscope="itemscope" itemtype="https://schema.org/PropertyValue">
                                                <td>
                                                    <div class="product-info-table-title"><span itemprop="name">Кратность продажи</span></div>
                                                </td>
                                                <td class="proprightvalue">
                                                        <span itemprop="value"><?=$arResult['PROPERTIES']["KRATNOST_PRODAZHI"]["VALUE"]?>  <?=$arResult['PROPERTIES']["KRATNOST_PRODAZHI"]["HINT"]?></span>
                                                </td>
                                            </tr>
                                            <? } ?>
                                            ...
                                            <tr itemprop="additionalProperty" itemscope="itemscope" itemtype="https://schema.org/PropertyValue">
                                                <td>
                                                    <div class="product-info-table-title"><span itemprop="name">Упаковка</span></div>
                                                </td>
                                                <td class="proprightvalue">
                                                        <span itemprop="value"><?=$arResult['PROPERTIES']["UPAKOVKA"]["VALUE"]?>  <?=$arResult['PROPERTIES']["UPAKOVKA"]["HINT"]?></span>
                                                </td>
                                            </tr>
                                            <? } ?>
                                    </table>
