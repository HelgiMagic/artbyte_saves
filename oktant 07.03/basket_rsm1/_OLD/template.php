	...
	?>
		<form method="post" action="<?=POST_FORM_ACTION_URI?>" name="basket_form" id="basket_form">
			...
			<ul class="tabs-nav" data-tabs="#basket-tabs">
				<li class="active"><a href="#basket-tab-1" onclick="showBasketItemsList()" >Готовые к заказу товары</a></li>
				<li><a href="#basket-tab-2" onclick="showBasketItemsList(2)">Отложенные товары</a></li>
			</ul>
