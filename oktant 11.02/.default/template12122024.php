                            ...
                            <div class="product-form-body">
                                ...
                                <div class="item-prices prodelement" itemprop="offers" itemscope="itemscope" itemtype="https://schema.org/Offer">
                                    ...
                                    */ ?>
											...
											<div class="item-price-current" id="<?=$arItemIDs['PRICE']?>"><?= $curpriceround; ?><? if (!empty($curpricecop)): ?> <sup><?= $curpricecop; ?></sup> <span class="rouble">q</span><? endif; ?></div>
											...
											if ($arParams['SHOW_OLD_PRICE'] === 'Y')
											{
												...
												<? } ?>
													<div class="item-price-old" id="<?=$arItemIDs['OLD_PRICE']?>" style="display: <?=($showDiscount ? '' : 'none')?>;">
														<?= $oldpriceround; ?><? if (!empty($oldpricecop)): ?> <sup><?= $oldpricecop; ?></sup> <? endif; ?><span class="rouble">o</span>
													</div>
