                ...
                foreach ($arResult['PHOTO_LIST'] as $f):
                    ...
                    <div class="product-main-slide">
                        <div class="product-main-img">
                            <a href="<?= $f; ?>" class="glightbox"><img <?if(((!empty($currentprice))OR(!empty($oldprice)))AND(($currentprice!='0.01')OR($oldprice!='0.01'))):?>itemprop="image"<? endif; ?> src="<?= $f; ?>" alt="<?= $name; ?> фото <?= $cn; ?>" title="<?= $name; ?> фото <?= $cn; ?>"></a>
                        </div>
                    </div>
                    <?
                    $cn++;
                    	...
                    	<div class="opisanieblocks twoblocksinner product-specifications-row">
                            ...
                            <?
									...
									while($enum_fieldsH = $property_enumsH->GetNext())
									{
							            ...
							            ?>
							    <? if($resAvtH->SelectedRowsCount() > 0) { ?>       
	                            <h2 class="product-info-title">Документация</h2>
	                            <? } ?>
	                            ...
	                            <div class="">
                                    <table class="product-info-table product-specifications-table">
                                            ...
                                            <tr <?if(((!empty($currentprice))OR(!empty($oldprice)))AND(($currentprice!='0.01')OR($oldprice!='0.01'))):?> itemprop="additionalProperty" itemscope="itemscope" itemtype="https://schema.org/PropertyValue"<? endif; ?>>
                                                ...
                                                <td class="proprightvalue">
                                                        <span <?if(((!empty($currentprice))OR(!empty($oldprice)))AND(($currentprice!='0.01')OR($oldprice!='0.01'))):?> itemprop="value" <? endif; ?>><?=round($arResult['PROPERTIES']["OBYOM"]["VALUE"], 6)?>  <?=$arResult['PROPERTIES']["OBYOM"]["HINT"]?></span>
                                                </td>
                                            </tr>
                                            <? } ?>
                                            <? if(!empty($arResult['PROPERTIES']["KRATNOST_PRODAZHI"]["VALUE"])) { ?>
									...
									while($enum_fields2 = $property_enums->GetNext())
									{
							            ...
							            while($obAvt = $resAvt->GetNextElement())
							            {
							                ...
							                <div class="techphoto">
												...
												<div class="descph"><?=$fileparams["DESCRIPTION"]?></div>
											</div> 
							            <?}
										}
										}
