    ...
    <section class="cart-delivery">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="cart-delivery__content">
                        <div class="cart-delivery__heading">
                            <span>Выберите способ доставки</span>
                        </div>
                        <div class="row">
                            <div class="col-4">
                                <div class="cart-delivery__select active">
                                    <h4>Самовывоз со склада</h4>
                                    <span>Бесплатно <br>в тот же день</span>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="cart-delivery__select">
                                    <h4>Доставка по городу <br>
                                        Санкт-Петербург или Ярославль</h4>
                                    <span>Стоимость доставки 500 руб. <br>Доставка осуществляется в течение дня</span>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="cart-delivery__select">
                                    <h4>Доставка по России</h4>
                                    <span>Стоимость доставки определяется <br>выбранным населенным пунктом.</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-6">
                    <div class="cart-delivery__tabs">
                        <ul>
                            ...
                            <li>
                                <a class="active" href="">Ярославль</a>
                            </li>
                        </ul>
                    </div>
                    <div class="cart-delivery__table">
                        <table>
                            <thead>
                            <tr>
                                <td>Адрес склада</td>
                                <td>Время на доставку</td>
                            </tr>
                            </thead>
                            <tbody>
                            <tr class="item">
                                <td class="item__stock active">
                                    <h4>Склад №1</h4>
                                    <span>проспект Александровской фермы, Д. 29 литера С</span>
                                </td>
                                <td class="item__day-delivery active">
                                    <span>Сегодня</span>
                                </td>
                            </tr>
                            <tr class="item">
                ...
                <div class="col-6">
                    <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3Ab477d9ec0c80a62f8a867f81ed99260698dc403a214853d9ec6d9b5c846463a9&amp;source=constructor" width="100%" height="324" frameborder="0"></iframe>
                </div>
            </div>
        </div>
    </section>
    <section class="cart-delivery-info">
        <div class="container">
            <div class="row">
                <div class="col-8">
                    <div class="cart-delivery-info__heading">
                        <span>Контактная информация</span>
                    </div>
                </div>
                <div class="col-4">
                    <div class="cart-delivery-info__heading">
                        <span>Дата получения заказа</span>
                    </div>
                </div>
                <div class="col-8">
                    <div class="cart-delivery-info__form">
                        <div class="row">
                            <div class="col-12">
                                <div class="cart-delivery-info__ele-wrap">
                                    <input type="text" placeholder="Ф.И.О. получателя заказа*">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="cart-delivery-info__ele-wrap">
                                    <input type="text" placeholder="Е-mail получателя заказа">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="cart-delivery-info__ele-wrap">
                                    <input type="text" placeholder="Телефон контактного лица по заказу*">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="cart-delivery-info__check">
                                    <input id="check1" type="checkbox" name="check" value="check1">
                                    <label for="check1">Уведомлять о степени готовности <br>
                                        заказа по e-mail</label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-4">
                    <div class="date-order">
                        <div class="date-order__dropdown">
                            <span>23.09.2018, пятница</span>
                        </div>
                        <div class="date-order__check">
                            <input id="check2" type="checkbox" name="check" value="check">
                            <label for="check2">Я хотел бы указать желаемое <br>
                                время доставки</label>
                        </div>
                        <div class="date-order__time">
                            <span>Время доставки</span>
                            <div class="date-order__dropdown time">
                                <span>12:00</span>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="payment__tabs">
                    ...
                    <a href="" class="button">Перейти к выбыору способа оплаты</a>
                    <div class="payment__check">
                        <input id="check3" type="checkbox" name="check" value="check">
                        <label for="check3">я согласен (-на) на обработку <br>
                            конфиденциальных данных</label>
